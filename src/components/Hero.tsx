      ...
      <div className="container mx-auto px-4 z-10 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            The Demand Generation <span className="text-gradient">KOL Marketing Agency</span>
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            BuzzCreatorz is a Web3 influencer marketing and creator growth agency that connects blockchain and crypto projects with trusted KOLs, alpha communities, and data-backed campaigns to accelerate adoption and market leadership.
          </p>
